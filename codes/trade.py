    ...
    def buy(self):
        ...
        for t in range(0, len(self.trend) - 1, self.skip):
            ...
            if action == 1 and starting_money >= self.trend[t]:
                ...
                starting_money -= self.trend[t]
                states_buy[t] = (
                    f'Day {t}: Buy 1 unit at Price {self.trend[t]:.2f}, Total Balance {starting_money:.2f}'
                )
                ...
                try:
                    ...
                    invest = 0
                states_sell[t] = (
                    f'Day {t}, Sell 1 unit at Price {self.trend[t]:.2f}, Investment {invest:.2f}%, Total Balance {starting_money:.2f}'
                )
